...
function steamPlayers(playerCount) {
  ...
  return (
    <OverlayTrigger placement="top" overlay={steamPlayersTooltip}>
      <div style={[InstanceDetailsStyles.currentPlayers]}>
        <img style={{height: 'calc(20px + 0.5vw)', paddingTop: '2%', marginRight: '4px', width: 'auto'}}src="https://upload.wikimedia.org/wikipedia/commons/8/83/Steam_icon_logo.svg" />
        ...
        <InstanceDetails imageURL={coverURL}>
          <div style={[InstanceDetailsStyles.gamePrimaryDataCluster]}>
            ...
            <div style={[InstanceDetailsStyles.secondaryDataCluster]}>
              ...
              {this.props.vindex != undefined ? visibilityIndex(this.props.vindex) : ''}
              {this.props.metacritic ? metacritic(this.props.metacritic) : ''}
              {this.props.steam_id ? steamPlayers(33000) : ''}
            </div>
